...
class TextRenderer:
    ...
    def __init__(self):
        ...
        self.font_path = font_manager.findfont(font_manager.FontProperties(family=['sans']))
        self.fonts = {}
    ...
    def draw_text(self, draw, text, position, font_size=40, color=(255, 255, 255, 255), anchor="mm"):
        """Draw text at the specified position"""
        font = self.get_font(font_size)
        draw.text(position, text, fill=color, font=font, anchor=anchor)
    
    def draw_wrapped_text(self, draw, text, position, max_width, font_size=40, 
                          color=(255, 255, 255, 255), anchor="lm"):
