...
class PodcastLayout(BaseLayout):
    ...
    def __init__(self, video_width=1920, video_height=1080, 
                 header_height=150, dp_size=(120, 120),
    ...
    def create_frame(self, current_sub=None, opacity=255, background_color=(20, 20, 20)):
        ...
        for speaker, profile in self.speakers.items():
            ...
            if self.show_speaker_names:
                ...
                self.text_renderer.draw_text(
                    draw, speaker, (pos[0] + self.dp_size[0]//2, name_y),
                    font_size=30, color=(200, 200, 200, opacity), anchor="mm"
                )
    ...
    def _draw_subtitle(self, frame, draw, subtitle, opacity):
        ...
        if speaker in self.speakers:
            ...
            self.speakers[speaker].highlight(draw, speaker_pos, 
                                           color=highlight_color, opacity=opacity)
            ...
            self.text_renderer.draw_wrapped_text(
                ...
                max_width=text_width, font_size=40,
                color=(255, 255, 255, opacity), anchor="lm"
            )
