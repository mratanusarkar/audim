...
def _srt_audio_player(subs, start_time):
    """Play audio with subtitles in CLI at the correct time"""
    for sub in subs:
...
def play_audio_with_subtitles(audio_file, srt_file):
    """
    Play audio file with synchronized subtitles
    ...
    try:
        ...
        subtitle_thread = threading.Thread(target=_srt_audio_player, args=(subs, start_time))
